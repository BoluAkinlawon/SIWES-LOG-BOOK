...
if(isset($_POST['submit'])){
	...
	$query= "SELECT matric_number, password from student where matric_number ='$matric'and password ='$password'";
...
<input name ="matric" type ="text" placeholder ="Matric Number" style="width: 250px; height: 30px; text=border: 1px solid brown; border-radius: 05px; padding: 20px 15px 20px 15px; margin: 10px 0px 15 px 0px;"required></input>
